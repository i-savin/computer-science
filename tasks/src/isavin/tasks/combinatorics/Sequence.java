...
public class Sequence {
	...
	/**
	 * Ќапечатать все последовательности чисел от 0 до n длины k
	 */
	...
	/**
	 * Ќапечатать все подмножества множества 1..k
	 */
	...
	/**
	 * Ќапечатать все послудовательности числе длины k такие что a[i]<=i
	 */
	...
	/**
	 * ¬озвращает следующий элемент лексикографической последовательности массивов (пр€мой пор€док):
	...
	/**
	 * ¬озвращает следующий элемент лексикографической последовательности массивов (обратный пор€док):
